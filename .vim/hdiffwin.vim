...
noremap <unique> <script> <SID>ltor				:echo "diff converts left window to right window: \\dl=<--cp  \\dr=cp-->"<CR>
noremap <unique> <script> <SID>rtol				:echo "diff converts right window to left window: \\dl=<--cp  \\dr=cp-->"<CR>
